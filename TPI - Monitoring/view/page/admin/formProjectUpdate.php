    ...
    <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2 mt-20 mb-32">
        <form class='mt-5 mb-5' method='post' action='index.php?controller=admin&action=update&id=<?php echo $project[0]['idProject'];?>'>
            ...
            <div class="grid grid-cols-1 mt-5 mx-7">
                ...
                <input class="py-2 px-3 rounded-lg border-2 border-teal-300 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:border-transparent" id="proName" name="proName" type="text" value="<?php echo $project[0]['proName'];?>" />
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                <div class="grid grid-cols-1">
                    ...
                    <input class="py-2 px-3 rounded-lg border-2 border-teal-300 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:border-transparent" id="proStart" name="proStart" type="text" value="<?php echo $project[0]['proStart'];?>" />
                </div>
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Date de fin | Format : yyyy-mm-dd</label>
                    <input class="py-2 px-3 rounded-lg border-2 border-teal-300 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:border-transparent" id="proEnd" name="proEnd" type="text" value="<?php echo $project[0]['proEnd'];?>" />
                </div>
            </div>
